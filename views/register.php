        ...
        <div class="hidden lg:flex bg-white rounded-3xl shadow-xl overflow-hidden fade-in" style="min-height:480px">
            ...
            <div class="w-2/5 bg-gradient-to-br from-orange-50 to-orange-100 flex flex-col items-center justify-center p-10 space-y-6">
                ...
                <div class="text-center space-y-1">
                    <p class="text-xs text-gray-500 uppercase tracking-wide font-semibold">Join</p>
                ...
                <div class="space-y-3 w-full">
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm flex-shrink-0">
                            <svg class="w-4 h-4 text-primary" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/></svg>
                        </div>
                        <p class="text-sm text-gray-700 font-medium">Personalized Account</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm flex-shrink-0">
                        ...
                        <p class="text-sm text-gray-700 font-medium">Easy Catering Booking</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm flex-shrink-0">
                            <svg class="w-4 h-4 text-yellow-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                        </div>
                        <p class="text-sm text-gray-700 font-medium">Leave Reviews</p>
                    </div>
                </div>
            ...
            <!-- ── Right: form panel ── -->
            <div class="flex-1 flex flex-col justify-center px-10 py-6 space-y-3">
                <div class="space-y-1">
                    <h1 class="text-2xl font-bold text-gray-900">Sign Up</h1>
                    <p class="text-gray-500 text-sm">Create your account to start ordering your favorite meals.</p>
                </div>
                ...
                <form method="POST" action="" class="space-y-2">
                    <div class="space-y-1">
                        <label for="full_name_d" class="block text-xs font-semibold text-gray-700 uppercase tracking-wide">Full Name</label>
                        <div class="relative">
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            </div>
                            <input type="text" id="full_name_d" name="full_name" placeholder="Juan Dela Cruz"
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePwd('password_d','eye1D')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                                <svg id="eye1D" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-1">
                        <label for="confirm_password_d" class="block text-xs font-semibold text-gray-700 uppercase tracking-wide">Confirm Password</label>
                        <div class="relative">
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            </div>
                            <input type="password" id="confirm_password_d" name="confirm_password" placeholder="••••••••"
                                class="input-field w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-primary focus:ring-2 focus:ring-orange-100 transition"
                                required autocomplete="new-password">
                            <button type="button" onclick="togglePwd('confirm_password_d','eye2D')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                                <svg id="eye2D" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </button>
                    ...
                    <button type="submit" class="touch-feedback w-full bg-gradient-to-r from-primary to-orange-500 text-white py-3 rounded-full font-bold text-sm tracking-widest shadow-lg hover:from-orange-600 hover:to-orange-600 transition uppercase">Mag-Register &rarr;</button>
                </form>
                ...
                <p class="text-center text-gray-600 text-sm">May account na? <a href="<?php echo htmlspecialchars(BASE_PATH . '/login.php?redirect=' . urlencode($redirect), ENT_QUOTES, 'UTF-8'); ?>" class="font-bold text-primary hover:text-orange-600 transition">Login</a></p>
        ...
        <div class="lg:hidden">
            <div class="bg-white rounded-3xl shadow-xl px-6 py-8 sm:px-8 space-y-6 fade-in">
                ...
                <form method="POST" action="" class="space-y-4">
                    <div class="space-y-2">
                        <label for="full_name" class="block text-xs font-semibold text-gray-700 uppercase tracking-wide">Full Name</label>
                        <div class="relative">
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" placeholder="••••••••"
                                class="input-field w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-primary focus:ring-2 focus:ring-orange-100 transition"
                                required autocomplete="new-password">
                            <button type="button" onclick="togglePwd('password','eye1M')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                                <svg id="eye1M" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </button>
                    ...
                    <div class="space-y-2">
                        <label for="confirm_password" class="block text-xs font-semibold text-gray-700 uppercase tracking-wide">Confirm Password</label>
                        <div class="relative">
                            <div class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            </div>
                            <input type="password" id="confirm_password" name="confirm_password" placeholder="••••••••"
                                class="input-field w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-primary focus:ring-2 focus:ring-orange-100 transition"
                                required autocomplete="new-password">
                            <button type="button" onclick="togglePwd('confirm_password','eye2M')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                                <svg id="eye2M" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </button>
            ...
            <div class="flex justify-center mt-6">
                <div class="text-center space-y-1">
                    <div class="flex items-center justify-center space-x-2">
                        <svg class="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20"><path d="M5 3a1 1 0 00-1 1v4a3 3 0 002 2.83V17a1 1 0 102 0v-6.17A3 3 0 0110 8V4a1 1 0 00-1-1H5zM7 4.5V8a1 1 0 01-2 0V4.5h2zM14 3a1 1 0 00-1 1v4.17A3 3 0 0115 11v6a1 1 0 102 0v-6a3 3 0 002-2.83V4a1 1 0 00-2 0v3h-1V4a1 1 0 00-2 0v3h-1V4a1 1 0 00-1-1z"/></svg>
