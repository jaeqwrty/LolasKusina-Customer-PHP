    ...
    <footer class="md:hidden fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200 safe-bottom z-50">
        <div class="container mx-auto px-4">
            <div class="flex justify-around items-center py-3">
                ...
                <a href="/reviews.php" class="flex flex-col items-center <?php echo ($currentPage ?? '') == 'reviews' ? 'text-primary' : 'text-gray-500'; ?> hover:text-primary transition touch-feedback min-w-[60px]">
                    <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="/cart.php" class="flex flex-col items-center <?php echo ($currentPage ?? '') == 'order' ? 'text-primary' : 'text-gray-500'; ?> hover:text-primary transition touch-feedback relative min-w-[60px]">
                    <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="/profile.php" class="flex flex-col items-center <?php echo ($currentPage ?? '') == 'account' ? 'text-primary' : 'text-gray-500'; ?> hover:text-primary transition touch-feedback min-w-[60px]">
                    <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
