    ...
    <aside class="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 fixed top-0 left-0 h-full z-50 shadow-lg">
        ...
        <div class="p-6 border-b border-gray-100">
            <a href="/" class="flex items-center space-x-3">
                <img src="/images/logo.png" alt="Logo" class="h-12 w-12 rounded-full" onerror="this.style.display='none'">
                <div>
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            <a href="/" class="sidebar-link <?php echo ($currentPage ?? '') === 'packages' ? 'active' : ''; ?> flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-orange-50 hover:text-primary transition font-medium">
            ...
            <a href="/reviews.php" class="sidebar-link <?php echo ($currentPage ?? '') === 'reviews' ? 'active' : ''; ?> flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-orange-50 hover:text-primary transition font-medium">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                <span>Reviews</span>
            </a>
            <a href="/cart.php" class="sidebar-link <?php echo ($currentPage ?? '') === 'order' ? 'active' : ''; ?> flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-orange-50 hover:text-primary transition font-medium relative">
            ...
            <a href="/order_history.php" class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-orange-50 hover:text-primary transition font-medium">
            ...
            <a href="/profile.php" class="sidebar-link <?php echo ($currentPage ?? '') === 'account' ? 'active' : ''; ?> flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-orange-50 hover:text-primary transition font-medium">
    ...
    <div class="md:ml-64 desktop-main">
        ...
        <header class="hidden md:flex bg-white border-b border-gray-200 sticky top-0 z-40 px-8 py-4 items-center justify-between shadow-sm">
            ...
            <div class="flex items-center space-x-4">
                <!-- Cart icon -->
                <a href="/cart.php" class="relative p-2 text-gray-600 hover:text-primary transition">
