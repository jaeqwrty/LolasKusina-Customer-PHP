<?php
/**
 * Package Details View — Pure presentation (SRP)
 * 
 * Business logic handled by PackageDetailsController.
 * Receives: $package, $items, $pageTitle, $currentPage from controller.
 */
